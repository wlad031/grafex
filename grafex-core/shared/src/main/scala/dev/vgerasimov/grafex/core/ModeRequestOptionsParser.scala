...
/** Used for parsing strings representing request options into maps with string keys and string values.
  ...
  *
  * @example {{{
  * import dev.vgerasimov.grafex.dev.vgerasimov.grafex.core.ModeRequestOptionsParser.parse
  * import dev.vgerasimov.grafex.dev.vgerasimov.grafex.core.ModeRequestOptionsParser.ParseError
  *
