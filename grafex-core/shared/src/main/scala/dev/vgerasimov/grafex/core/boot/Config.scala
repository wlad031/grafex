...
/** Contains functionality for reading application configuration files.
  ...
  *
  * import dev.vgerasimov.grafex.dev.vgerasimov.grafex.core.boot.Config
  * import dev.vgerasimov.grafex.dev.vgerasimov.grafex.core.boot.Config.{ ConfigurationReadingError, GrafexConfiguration }
  *
